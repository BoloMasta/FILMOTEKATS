          ...
          <nav className="navigation">
            <ul className="navigation__list">
              <li className="navigation__item">
                <Link className="navigation__link--active" to="/">Home</Link>
              </li>
              <li className="navigation__item">
                <Link className="navigation__link" to="/library">My Library</Link>
              </li>
            </ul>
          </nav>
        </div>
        ...
        <div className="header__search-form">
          <form className="form__container form" autoComplete="off" id="home">
            <label className="form__label">
              <input type="text" name="searchQuery" placeholder="Movie search" className="form__input" />
            </label>
          ...
          <p className="notification off">Search result not successful. Enter the correct movie name.</p>
        </div>
      </div>
    </header>
  );
